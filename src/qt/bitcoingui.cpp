...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("AGORA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	QFont btn_font(":/fonts/ubuntu-regular", 11, QFont::Normal, false);
	btn_font.setPointSizeF(11.5);

	QIcon icon_overview = QIcon(":/icons/overview");
	icon_overview.addPixmap(QPixmap(":/icons/overview_on"), QIcon::Normal, QIcon::On);
	...
	QIcon icon_send = QIcon(":/icons/send");
	icon_send.addPixmap(QPixmap(":/icons/send_on"), QIcon::Normal, QIcon::On);
	sendCoinsAction = new QAction(icon_send, tr("&Send"), this);
	sendCoinsAction->setStatusTip(tr("Send coins to a AGORA address"));
	...
	QIcon icon_receive = QIcon(":/icons/receiving_addresses");
	icon_receive.addPixmap(QPixmap(":/icons/receiving_addresses_on"), QIcon::Normal, QIcon::On);
	receiveCoinsAction = new QAction(icon_receive, tr("&Receive"), this);
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and agora: URIs)"));
	...
	QIcon icon_history = QIcon(":/icons/history");
	icon_history.addPixmap(QPixmap(":/icons/history_on"), QIcon::Normal, QIcon::On);
	...
	if (settings.value("fShowMasternodesTab").toBool()) {
		QIcon icon_masternodes = QIcon(":/icons/masternodes");
		icon_masternodes.addPixmap(QPixmap(":/icons/masternodes_on"), QIcon::Normal, QIcon::On);
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AGORA"), this);
	aboutAction->setStatusTip(tr("Show information about AGORA"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setStatusTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for AGORA"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your AGORA addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AGORA addresses"));
	...
	openAction->setStatusTip(tr("Open a AGORA: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the AGORA help message to get a list with possible AGORA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("AGORA client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AGORA network", "", count));
}
...
{
	QString strTitle = tr("AGORA"); // default title
