...
/** Utility functions used by the AGORA Qt UI.
 */
namespace GUIUtil
{
...
// Render AGORA addresses in monospace font
...
// Parse "agora:" URI into recipient object, return true on successful parsing
