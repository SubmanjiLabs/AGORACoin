...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::AGOR, nValue);
...
{
    std::string genesisblockhash = "000001448e5459ccfd049fd3d5c6561a726f246063996b1b097691d94e0bd885";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (agora.conf).");
            QMessageBox::warning(this, "AGORA Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#23426b;}\n a, span { font-family: monospace; }\n span.addr {color:#23426b; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #23426b;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#23426b;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#23426b;}\n";
