...
#   c) node1 mines 32 blocks, so now node 0 has 60001agor, node 1 has 4250agor, node2 has none.
#   d) node0 sends 601 agor to node2, in two transactions (301 agor, then 300 agor).
