...
In order to support loading of multiple wallets in agora-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is agora.cpp.
...
Changes to agora.cpp
----------------------
agora.cpp is the entry point into agora-qt, and as such, will require some minor modifications to provide hooks for
