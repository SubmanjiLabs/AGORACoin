...
The AGORA project operates an open contributor model where anyone is
...
The following applies to code changes to the AGORA project, and is not to be
confused with overall AGORA Network Protocol consensus changes.

Whether a pull request is merged into AGORA rests with the project merge
...
Patches that change AGORA consensus rules are considerably more involved than
...
Where a patch set proposes to change the AGORA consensus, it must have been
...
The project leader is the release manager for each AGORA release.
