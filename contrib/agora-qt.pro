...
RESOURCES += src/qt/agora.qrc src/qt/agora_locale.qrc

TRANSLATIONS += src/qt/locale/agora_bg.ts \
                src/qt/locale/agora_de.ts \
                src/qt/locale/agora_en.ts \
                src/qt/locale/agora_es.ts \
                src/qt/locale/agora_fi.ts \
                src/qt/locale/agora_fr.ts \
                src/qt/locale/agora_it.ts \
                src/qt/locale/agora_ja.ts \
                src/qt/locale/agora_pl.ts \
                src/qt/locale/agora_pt.ts \
                src/qt/locale/agora_ru.ts \
                src/qt/locale/agora_sk.ts \
                src/qt/locale/agora_sv.ts \
                src/qt/locale/agora_vi.ts \
                src/qt/locale/agora_zh_CN.ts \
                src/qt/locale/agora_zh_TW.ts
